...
export default function EquipmentEdit() {
  ...
  if (!form) return <div style={{ textAlign: 'center', padding: '4rem', color: '#ef4444' }}>{error}</div>;
      ...
      <div className="card">
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            <button type="button" onClick={() => navigate(`/equipment/${id}`)} style={{ padding: '0.6rem 1.25rem', borderRadius: '8px', border: '1px solid #d1d5db', background: '#fff', cursor: 'pointer', color: '#374151' }}>
              Cancelar
            </button>
